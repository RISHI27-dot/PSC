...
gst-launch-1.0 \
  ...
  sink_1::startx=980 sink_1::starty=0 sink_1::width=640 sink_1::height=480 ! video/x-raw, width=1920, height=1080, format=NV12 ! queue ! kmssink driver-name=tidss sync=false force-modesetting=true
