...
v4l2-ctl -z platform:30102000.ticsi2rx -d "30102000.ticsi2rx context 2" -v width=1600,height=2,pixelformat=MET8
...
media-ctl -V '"30102000.ticsi2rx":0/1 [fmt:META_8/1600x2 field:none]'
...
media-ctl -V '"cdns_csi2rx.30101000.csi-bridge":0/1 [fmt:META_8/1600x2 field:none]'
...
media-ctl -V '"ds90ub960 4-0030":0/1 [fmt:META_8/1600x2 field:none]'

# ds90ub953
media-ctl -R '"ds90ub953 4-0044" [0/0 -> 1/0 [1], 0/1 -> 1/1 [1]]'
media-ctl -V '"ds90ub953 4-0044":0/0 [fmt:SBGGI10_1X10/1600x1300 field:none]'
media-ctl -V '"ds90ub953 4-0044":0/1 [fmt:META_8/1600x2 field:none]'
